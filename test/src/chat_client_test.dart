...
void main() {
  test('resumeSession returns a loading engine, then hydrates it from history', () async {
    ...
    expect(engine.state.isLoading, isTrue, reason: 'returned synchronously, mid-load');
